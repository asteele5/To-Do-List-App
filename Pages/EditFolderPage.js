...
export default class App extends Component {
  ...
  render() {
    ...
    const changeFolder = this.props.route.params.changeFolder;
    const currentFolder = this.props.route.params.currentFolder;
    const removeFolder = this.props.route.params.removeFolder;
    return (
        ...
        <View style={styles.container}>
          ...
          <View style={styles.newListItemContainer}>
            <TextInput
              ...
              onSubmitEditing={changeFolder(this.state.input, currentFolder)}
